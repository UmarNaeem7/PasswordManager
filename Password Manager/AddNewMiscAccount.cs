...
{
    public partial class AddNewMiscAccount : Form
    {
        private SqlConnection conn;
        public AddNewMiscAccount(SqlConnection connection)
        {
            InitializeComponent();
        ...
        {
            if (this.infoTextBox.Text.Equals(""))
            {
            ...
            string cmdText = @"insert into miscellaneous values (@info, @email, @password, @comments)";
